...
def nameCards(tag):
    ...
    ## Wplus
    #os.system('cp /afs/cern.ch/work/r/rebeca/hww_signal_gridpacks_II/CMSSW_7_1_14/src/genproductions/bin/Powheg/production/V2/13TeV/Higgs/HWJ_JHUGen_HWW2L2Nu_NNPDF30_13TeV/HWplusJ_HanythingJ_NNPDF30_13TeV_TEMPLATE.input /afs/cern.ch/work/r/rebeca/hww_signal_gridpacks_II/CMSSW_7_1_14/src/genproductions/bin/Powheg/production/V2/13TeV/Higgs/HWJ_JHUGen_HWW2L2Nu_NNPDF30_13TeV/HWplusJ_HanythingJ_NNPDF30_13TeV_M'+mass+'.input')
...
for mass in [115,120,124,125,126,130,135,140,145,150,155,160,165,170,175,180,190,200,210,230,250,270,300,350,400,450,500,550,600,700,800,900,1000]:
    nameCards(str(mass))
